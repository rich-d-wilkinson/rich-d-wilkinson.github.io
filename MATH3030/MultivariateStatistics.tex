...
These lecture notes are now \textbf{complete}. I'll continue to correct typos but will not be adding additional material.
...
\end{lemma}
\begin{proof}
\iffalse{} {Proof. } \fi{}If \(\mathbf A\) is positive definite, and if \(\mathbf x\) is a unit-eigenvector of \(\mathbf A\) corresponding to \(\lambda_n\), then
...
\NormalTok{(iris.k <-}\StringTok{ }\KeywordTok{kmeans}\NormalTok{(iris2, }\DataTypeTok{centers =} \DecValTok{3}\NormalTok{, }\DataTypeTok{nstart=}\DecValTok{25}\NormalTok{)) }
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{fviz_cluster}\NormalTok{(iris.k, }\DataTypeTok{data =}\NormalTok{ iris2,}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{table}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Species, iris.k}\OperatorTok{$}\NormalTok{cluster)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{fviz_nbclust}\NormalTok{(iris2, kmeans, }\DataTypeTok{method =} \StringTok{"wss"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{proof}
\iffalse{} {Proof. } \fi{}Suppose observation \(i\), \(\mathbf x_i\), gets classified to cluster \(\hat{\mathcal{C}}_j\) according to the maximum likelihood estimator, i.e.,
\[\hat{\delta}(i)=j\]
...
\NormalTok{iris.m <-}\StringTok{ }\KeywordTok{Mclust}\NormalTok{(iris2,}\DataTypeTok{G=}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(iris.m, }\DataTypeTok{what =} \KeywordTok{c}\NormalTok{(}\StringTok{"classification"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{10-clustering_files/figure-latex/unnamed-chunk-12-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(iris.m, }\DataTypeTok{what =} \KeywordTok{c}\NormalTok{(}\StringTok{"density"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{10-clustering_files/figure-latex/unnamed-chunk-12-2.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(D <-}\StringTok{ }\KeywordTok{as.dist}\NormalTok{(}\KeywordTok{matrix}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,}
                      ...
                      \DecValTok{7}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{8}\NormalTok{,}\DecValTok{0}\NormalTok{), }\DataTypeTok{nr=}\DecValTok{5}\NormalTok{, }\DataTypeTok{byrow=}\NormalTok{T)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{D.sl <-}\KeywordTok{hclust}\NormalTok{(D, }\DataTypeTok{method=}\StringTok{"single"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cutree}\NormalTok{(D.sl,}\DataTypeTok{k=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(D.sl)}
\end{Highlighting}
\end{Shaded}

\includegraphics{10-clustering_files/figure-latex/unnamed-chunk-19-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cutree}\NormalTok{(D.sl, }\DataTypeTok{h=}\FloatTok{4.5}\NormalTok{) }\CommentTok{# note we specify h= for height}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(}\KeywordTok{hclust}\NormalTok{(D, }\DataTypeTok{method=}\StringTok{"complete"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{D.ga <-}\StringTok{ }\KeywordTok{hclust}\NormalTok{(D, }\DataTypeTok{method=}\StringTok{"average"}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(D.ga)}
\end{Highlighting}
\end{Shaded}

\includegraphics{10-clustering_files/figure-latex/unnamed-chunk-25-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cutree}\NormalTok{(D.sl, }\DataTypeTok{h=}\DecValTok{6}\NormalTok{) }\CommentTok{# cut the tree at height 6}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cutree}\NormalTok{(D.ga, }\DataTypeTok{h=}\DecValTok{6}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(dplyr)}
\NormalTok{IPL<-}\KeywordTok{read.csv}\NormalTok{(}\StringTok{'IPL.csv'}\NormalTok{)}
\NormalTok{IPL10<-IPL }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Mat.x}\OperatorTok{>=}\DecValTok{10}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(PLAYER,Runs.x, HS, Avg.x, BF, SR.x, X4s, X6s)}
\end{Highlighting}
\end{Shaded}
...
\[\mathbf P_{\mathcal{C}(X)}\mathbf y=\arg \min_{\mathbf y': \mathbf y' \in \mathcal{C}(X)} ||\mathbf y-\mathbf y'||_2.\]
and by Proposition \ref{prp:orthogprojection} this is
\[\mathbf P_{\mathcal{C}(X)}\mathbf y= \mathbf X(\mathbf X^\top \mathbf X)^{-1}\mathbf X^\top \mathbf y=\hat{\mathbf y}\]
which again implies\\
\[\hat{\boldsymbol \beta}=(\mathbf X^\top \mathbf X)^{-1}\mathbf X^\top \mathbf y\]
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lm}\NormalTok{(Sepal.Length}\OperatorTok{~}\StringTok{ }\NormalTok{Sepal.Width}\OperatorTok{+}\NormalTok{Petal.Length}\OperatorTok{+}\NormalTok{Petal.Width,}\DataTypeTok{data=}\NormalTok{iris)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris.pca <-}\StringTok{ }\KeywordTok{prcomp}\NormalTok{(iris[,}\DecValTok{2}\OperatorTok{:}\DecValTok{4}\NormalTok{],}\DataTypeTok{scale=}\OtherTok{TRUE}\NormalTok{)}
\NormalTok{Z =}\StringTok{ }\NormalTok{iris.pca}\OperatorTok{$}\NormalTok{x[,}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{] }\CommentTok{# select the first two PCs}
\NormalTok{iris.lm <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(iris}\OperatorTok{$}\NormalTok{Sepal.Length}\OperatorTok{~}\NormalTok{Z)}
\NormalTok{iris.lm}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris.pca}\OperatorTok{$}\NormalTok{rotation[,}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{] }\OperatorTok{%*%}\StringTok{ }\KeywordTok{coef}\NormalTok{(iris.lm)[}\OperatorTok{-}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{iris.pcr <-}\StringTok{ }\KeywordTok{pcr}\NormalTok{(Sepal.Length}\OperatorTok{~}\StringTok{ }\NormalTok{Sepal.Width}\OperatorTok{+}\NormalTok{Petal.Length}\OperatorTok{+}\NormalTok{Petal.Width, }\DecValTok{2}\NormalTok{, }\CommentTok{# number of components,}
                \DataTypeTok{scale=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{data=}\NormalTok{iris)}
\KeywordTok{coef}\NormalTok{(iris.pcr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris.pcr2 <-}\StringTok{ }\KeywordTok{pcr}\NormalTok{(Sepal.Length}\OperatorTok{~}\StringTok{ }\NormalTok{Sepal.Width}\OperatorTok{+}\NormalTok{Petal.Length}\OperatorTok{+}\NormalTok{Petal.Width, }\DecValTok{3}\NormalTok{, }\CommentTok{# number of components,}
                \DataTypeTok{scale=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{data=}\NormalTok{iris, }\DataTypeTok{validation=}\StringTok{'CV'}\NormalTok{)}
\KeywordTok{summary}\NormalTok{(iris.pcr2)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{X =}\StringTok{ }\KeywordTok{as.matrix}\NormalTok{(iris[,}\DecValTok{2}\OperatorTok{:}\DecValTok{4}\NormalTok{]) }\CommentTok{# glmnet doesn't work with data frames}
\NormalTok{y=iris[,}\DecValTok{1}\NormalTok{]}
\NormalTok{lambdas <-}\StringTok{ }\DecValTok{10}\OperatorTok{^}\KeywordTok{seq}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{-4}\NormalTok{, }\DataTypeTok{by =} \FloatTok{-.1}\NormalTok{)}
\NormalTok{iris.ridge <-}\StringTok{ }\KeywordTok{glmnet}\NormalTok{(X,y, }\DataTypeTok{alpha=}\DecValTok{0}\NormalTok{, }\DataTypeTok{lambda =}\NormalTok{ lambdas)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(iris.ridge, }\DataTypeTok{xvar=}\StringTok{'lambda'}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#matplot(log(lambdas), t(iris.ridge$beta), type='l') # does the same}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{coef}\NormalTok{(}\KeywordTok{lm}\NormalTok{(y}\OperatorTok{~}\NormalTok{X))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cv_fit <-}\StringTok{ }\KeywordTok{cv.glmnet}\NormalTok{(X, y, }\DataTypeTok{alpha =} \DecValTok{0}\NormalTok{, }\DataTypeTok{lambda =}\NormalTok{ lambdas)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cv_fit}\OperatorTok{$}\NormalTok{lambda.min }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cv_fit}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{multioutput-linear-model}{%
\section{Multioutput Linear Model}\label{multioutput-linear-model}}
...
\begin{proposition}
\protect\hypertarget{prp:eight1}{}{\label{prp:eight1} }The maximum likelihood estimator of \(\mathbf B\) is
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(pls)}
\KeywordTok{data}\NormalTok{(gasoline)}
\KeywordTok{matplot}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\DecValTok{900}\NormalTok{,}\DecValTok{1700}\NormalTok{,}\DecValTok{2}\NormalTok{),}\KeywordTok{t}\NormalTok{(gasoline}\OperatorTok{$}\NormalTok{NIR), }\DataTypeTok{type=}\StringTok{'l'}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'log(1/R)'}\NormalTok{, }\DataTypeTok{xlab=}\StringTok{'wavelength (nm)'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lm}\NormalTok{(octane}\OperatorTok{~}\NormalTok{NIR, }\DataTypeTok{data=}\NormalTok{gasoline)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gasoline.pcr <-}\StringTok{ }\KeywordTok{pcr}\NormalTok{(octane}\OperatorTok{~}\NormalTok{NIR, }\DataTypeTok{data=}\NormalTok{gasoline, }\DataTypeTok{validation=}\StringTok{'CV'}\NormalTok{)}
\KeywordTok{summary}\NormalTok{(gasoline.pcr)}
\KeywordTok{plot}\NormalTok{(}\KeywordTok{RMSEP}\NormalTok{(gasoline.pcr), }\DataTypeTok{legendpos =} \StringTok{"topright"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lm}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(Sepal.Length, Sepal.Width) }\OperatorTok{~}\StringTok{ }\NormalTok{Petal.Length}\OperatorTok{+}\NormalTok{Petal.Width, }\DataTypeTok{data=}\NormalTok{iris)}
\end{Highlighting}
\end{Shaded}
...
\item
  Let
  \[\hat{\boldsymbol \beta}_\lambda=\arg \min_{\boldsymbol \beta} ||\mathbf y-\mathbf X\boldsymbol \beta||^2+\lambda ||\boldsymbol \beta||\]
