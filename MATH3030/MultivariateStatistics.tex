...
So for this dataset, \(n=60,000\) and \(p=784\).
...
\caption{\label{fig:unnamed-chunk-4}Charles Joseph Minard's famous map of Napoleon's 1812 invasion of Russian. It displays \href{https://en.wikipedia.org/wiki/Charles_Joseph_Minard\#The_map_of_Napoleon's_Russian_campaign}{six types of data in two dimensions}.}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-5}Scatter plots of goals for (F), goals against (A) and points (PT) for a recent Premier League Season}
\end{figure}
...
\includegraphics[width=1\linewidth]{01-statistical-prelim_files/figure-latex/unnamed-chunk-6-1}
...
\includegraphics{01-statistical-prelim_files/figure-latex/unnamed-chunk-7-1.pdf}
...
\protect\hypertarget{exm:unnamed-chunk-8}{}{\label{exm:unnamed-chunk-8} \iffalse (Task 1) \fi{} }The table below shows the module marks for 5 students on the modules G11PRB (\(P\)) and G11STA (\(S\)).
\end{example}
...
\protect\hypertarget{exm:unnamed-chunk-13}{}{\label{exm:unnamed-chunk-13} \iffalse (Task 2) \fi{} }
...
\protect\hypertarget{exm:unnamed-chunk-15}{}{\label{exm:unnamed-chunk-15} \iffalse (Task 3) \fi{} }We can 100 generate samples from the multivariate normal distribution with mean vector
...
These four different 3s differ in more than just the first two principal components, but you can see the effect of the PC1 score is to slot the image forward or backward, whereas PC2 changes the thickness of the line.
...
\begin{Shaded}
\begin{Highlighting}[]
 \KeywordTok{c}\NormalTok{(}\FloatTok{4.22}\NormalTok{ , }\FloatTok{2.38}\NormalTok{ , }\FloatTok{1.88}\NormalTok{ , }\FloatTok{1.11}\NormalTok{ , }\FloatTok{0.91}\NormalTok{ , }\FloatTok{0.82}\NormalTok{ , }\FloatTok{0.58}\NormalTok{, }\FloatTok{0.44}\NormalTok{ , }\FloatTok{0.35}\NormalTok{ , }\FloatTok{0.19}\NormalTok{ , }\FloatTok{0.05}\NormalTok{ , }\FloatTok{0.04}\NormalTok{ , }\FloatTok{0.04}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
