...
\texttt{r.d.wilkinson@nottingham.ac.uk}
...
\FunctionTok{qplot}\NormalTok{(PC1, PC2, }\AttributeTok{colour=}\NormalTok{Species, }\AttributeTok{data=}\NormalTok{iris)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(ggplot2)}
\FunctionTok{qplot}\NormalTok{(mnist3.pca}\SpecialCharTok{$}\NormalTok{x[,}\DecValTok{1}\NormalTok{], mnist3.pca}\SpecialCharTok{$}\NormalTok{x[,}\DecValTok{2}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{eta2 }\OtherTok{=}\NormalTok{ prem.cca}\SpecialCharTok{$}\NormalTok{scores}\SpecialCharTok{$}\NormalTok{xscores[,}\DecValTok{1}\NormalTok{] }
...
\NormalTok{Z }\OtherTok{\textless{}{-}} \FunctionTok{as.matrix}\NormalTok{(iris[,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{])}\SpecialCharTok{\%*\%}\NormalTok{ V}
\NormalTok{ggplot2}\SpecialCharTok{::}\FunctionTok{qplot}\NormalTok{(Z[,}\DecValTok{1}\NormalTok{], Z[,}\DecValTok{2}\NormalTok{], }\AttributeTok{colour=}\NormalTok{iris}\SpecialCharTok{$}\NormalTok{Species, }\AttributeTok{xlab=}\StringTok{\textquotesingle{}LD1\textquotesingle{}}\NormalTok{,}
               \AttributeTok{ylab=}\StringTok{\textquotesingle{}LD2\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{iris}\SpecialCharTok{$}\NormalTok{PC1}\OtherTok{=}\NormalTok{iris.pca}\SpecialCharTok{$}\NormalTok{x[,}\DecValTok{1}\NormalTok{]}
\NormalTok{iris}\SpecialCharTok{$}\NormalTok{PC2}\OtherTok{=}\NormalTok{iris.pca}\SpecialCharTok{$}\NormalTok{x[,}\DecValTok{2}\NormalTok{]}
\NormalTok{ggplot2}\SpecialCharTok{::}\FunctionTok{qplot}\NormalTok{(PC1, PC2, }\AttributeTok{colour=}\NormalTok{Species, }\AttributeTok{data=}\NormalTok{iris)}
\end{Highlighting}
\end{Shaded}
...
## CV          0.8308   0.5465   0.3939   0.3231
## adjCV       0.8308   0.5462   0.3933   0.3225
## 
...
\addcontentsline{toc}{subsubsection}{Non-examinable extension}

To prove this using calculus is tricky, or at least it is, if we use the standard approach. However, there is another approach for proving this using the \emph{Fr'\{e\}chet derivative}. Recall that the usual definition of a derivative of a function \(f: \mathbb{R}\rightarrow \mathbb{R}\) satisfies
\[f(x+h)=f(x)+f'(x)h +o(h)\]
